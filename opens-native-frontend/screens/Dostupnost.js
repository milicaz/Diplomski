...
const ITEM_HEIGHT = moderateScale(46); // ili scale(46) u zavisnosti od izgleda
...
const styles = StyleSheet.create({
  ...
  headerText: {
    fontFamily: "Montserrat-Bold",
    fontSize: RFValue(35), // bio getFontSize(35)
    marginBottom: moderateScale(30), // bio scaleSize(30)
  },
  itemContainer: {
    flexDirection: "row",
    width: "90%",
    marginBottom: moderateScale(16), // bio scaleSize(16)
    height: ITEM_HEIGHT,
    alignItems: "center",
  },
  iconContainer: {
  ...
  icon: {
    height: moderateScale(48), // bio scaleSize(48)
    width: moderateScale(48),
    resizeMode: "contain",
  },
  itemText: {
    fontFamily: "Montserrat-Regular",
    paddingTop: moderateScale(5), // bio scaleSize(5)
    paddingBottom: moderateScale(5),
    paddingLeft: moderateScale(15),
    paddingRight: moderateScale(15),
    fontSize: RFValue(12), // bio getFontSize(12)
    overflow: "hidden",
    height: "100%",
    textAlignVertical: "center",
    justifyContent: "center",
