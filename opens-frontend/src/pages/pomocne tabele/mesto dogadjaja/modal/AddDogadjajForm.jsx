...
const AddDogadjajForm = () => {
    ...
    const handleDodaj = (event) => {
        ...
        console.log("Mesto dogadjaja je: " + JSON.stringify(mestoDogadjaja))
    ...
    return (
        <Form onSubmit={handleDodaj}>
            <Form.Group className="mb-3">
                <Form.Control name="nazivSale" value={mestoDogadjaja.nazivSale} onChange={handleChange} type="text" placeholder="Naziv " required />
            </Form.Group>
            <Form.Group>
